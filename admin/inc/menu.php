...
<!--Atendimentos-->
	...
	?>
 		...
 		<li class="treeview">
			...
			<?php if($usuario['nivel']=='5'){ // COMERCIAL & GERENCIAL ?>
				<li>
                <a href="painel.php?execute=suporte/atendimento/ouvidoria">
                 <span class="label label-primary pull-right"> <?php// echo $pedido;?></span>
                <i class="fa fa-circle-o text-aqua"></i>
                Ouvidoria
                </a>
			...
			<?php } ?>
			 ...
			 <?php if($usuario['nivel']=='5'){ // COMERCIAL & GERENCIAL ?>
				<li>
                <a href="painel.php?execute=suporte/atendimento/ouvidoria-externa">
                 <span class="label label-primary pull-right"> <?php// echo $pedido;?></span>
                <i class="fa fa-circle-o text-aqua"></i>
                Ouvidoria Externa
                </a>
			...
			<?php if($usuario['nivel']>='2'){ // COMERCIAL & GERENCIAL ?>
				<li>
                <a href="painel.php?execute=suporte/atendimento/atendimento-externo">
                 <span class="label label-primary pull-right"> <?php// echo $pedido;?></span>
                <i class="fa fa-circle-o text-aqua"></i>
                Atendimento Externo
                </a>
			...
			<?php } ?>
				...
				<li>
                <a href="painel.php?execute=suporte/atendimento/pedidos-operacional">
                 <span class="label label-primary pull-right"> <?php// echo $pedido;?></span>
                <i class="fa fa-circle-o text-aqua"></i>
                Operacinal
                </a>
				...
				//$refaturar = conta('receber',"WHERE refaturar='1' AND  refaturamento_autorizacao='1'");
					  ...
					  <?php //$autorizacao=conta('contrato_aditivo',"WHERE id AND aprovacao_comercial='3'");?>
                        ...
                        <li>
						  ...
						  <li>
                              <a href="painel.php?execute=suporte/receber/receber-desconto-solicitar">
							  <i class="fa fa-circle-o"></i>
							  Desconto
							  </a>
                            </li>
...
<!--ORDEM DE SERVIÇO-->
		...
		?>
                        ...
                        <li>
						 ...
						 <li>
                            <a href="painel.php?execute=suporte/ordem/ordem-avulsas">
							 <span class="label label-primary pull-right"></span>
							<i class="fa fa-circle-o text-aqua"></i>
							Avulsa
							</a>
	...
	<?php if($usuario['nivel']=='1'  //1 - Operacional 
			 ...
			 || $usuario['nivel']=='5'  // 5 - Gerencial 
			|| $usuario['nivel']=='2'  //2 - Atendimento ao Cliente
			 || $usuario['nivel']=='7'  //2 - Atendimento ao Cliente
			  || $usuario['nivel']=='12'  //2 - Portaria
...
<!--VEICULOS-->
            <li class="treeview">
               <a href="#">
                <i class="fa fa-car"></i>
				 ...
				 <ul class="treeview-menu">
                     <li><a href="painel.php?execute=suporte/veiculo/veiculos"><i class="fa fa-circle-o"></i>Veículos</a>
                       </li>
        ...
        <ul class="treeview-menu">
			...
			<li>
				 <a href="painel.php?execute=suporte/veiculo/check-list-manutencao"><i class="fa fa-circle-o">
					 </i>Check List
				 </a>
...
<!-- 12 portaria-->
	...
	<?php if($usuario['nivel']=='1'  //1 - Operacional 
			 || $usuario['nivel']=='9'  // 9 - Manutenção / Almoxarifado
			  || $usuario['nivel']=='3'  //  3 - Faturamento
			 || $usuario['nivel']=='5'  // 5 - Gerencial 
			|| $usuario['nivel']=='12'  //2 - 12 portaria
		){  
	?>	
                ...
                <li class="treeview">
                    ...
                    <a href="#">
						<i class="fa fa-file-text-o"></i>
						</i> <span>Portaria</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
                

                    <ul class="treeview-menu">
						
                         <li><a href="painel.php?execute=suporte/veiculo/check-list"><i class="fa fa-circle-o"></i>CheckList</a>
                            </li>
						
						  <li><a href="painel.php?execute=suporte/funcionario/diarias"><i class="fa fa-circle-o"></i>Diarias</a>
                            </li>
...
<!-- 13 oficiana-->
	...
	<?php if($usuario['nivel']=='1'  //1 - Operacional 
			|| $usuario['nivel']=='5'  // 5 - Gerencial 
			|| $usuario['nivel']=='13'  //2 - 12 portaria
		){  
	?>	
                ...
                <li class="treeview">
                    ...
                    <a href="#">
						<i class="fa fa-file-text-o"></i>
						</i> <span>Oficina</span> <i class="fa fa-angle-left pull-right"></i>
					</a>
                

                    <ul class="treeview-menu">
						
                         <li><a href="painel.php?execute=suporte/veiculo/manutencoes-oficina"><i class="fa fa-circle-o"></i>Manutenções</a>
                            </li>
...
<!--FATURAMENTO-->
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
						...
						<li>
                            <a href="painel.php?execute=suporte/faturamento/construir2">
							<i class="fa fa-circle-o text-aqua"></i>
							Construção 2
						 </a>
                        </li>
						 ...
						 NFe
							...
							*/
                            ...
                            <li>
							  ...
							  <li>
                              <a href="painel.php?execute=suporte/receber/receber-negociacoes">
							  <i class="fa fa-circle-o"></i>
							  Negociações
							  </a>
                            </li>
	...
	<!--CONTA A PAGAR-->
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
							...
							<li>
                                <a href="painel.php?execute=suporte/pagar/despesas-emissao">
								  <i class="fa fa-circle-o"></i>
								  Emissão
							  </a>
                            </li>
                            ...
                            <li>
                                <a href="painel.php?execute=suporte/pagar/despesas-pagas">
								  <i class="fa fa-circle-o"></i>
								  Quitadas
								  </a>
                            </li>
					   ...
					   <ul class="treeview-menu">
						 ...
						 <li>
						  ...
						  Retirada
						    ...
						    <li>
						  <a href="painel.php?execute=suporte/estoque/equipamento-retirada-descarte">
						  <i class="fa fa-circle-o"></i>
						  Descarte
						  </a>
						 </li>
...
<!--FUNCIONARIO-->
		<li class="treeview">
				...
				<ul class="treeview-menu">
					  <li>
					  <a href="#"><i class="fa fa-circle-o">
					  </i> Descontos<i class="fa fa-angle-left pull-right"></i>
					  </a>
                  
					   <ul class="treeview-menu">
						 <li>
						  <a href="painel.php?execute=suporte/funcionario/descontos">
							<i class="fa fa-circle-o"></i>
						 	Descontos
						 </a>
						 </li>
						   <li>
                                <a href="painel.php?execute=suporte/funcionario/desconto-motivo">
								  <i class="fa fa-circle-o"></i>
								  Motivo
							  </a>
                       	</li>
				...
				<ul class="treeview-menu">
					  <li>
					  <a href="#"><i class="fa fa-circle-o">
					  </i> EPI<i class="fa fa-angle-left pull-right"></i>
					  </a>
                  
					   <ul class="treeview-menu">
						 <li>
						  <a href="painel.php?execute=suporte/funcionario/epi">
							<i class="fa fa-circle-o"></i>
						 	EPI
						 </a>
						 </li>
						   <li>
                                <a href="painel.php?execute=suporte/funcionario/epi-tipo">
								  <i class="fa fa-circle-o"></i>
								  Tipo de EPI
							  </a>
                       	</li>
