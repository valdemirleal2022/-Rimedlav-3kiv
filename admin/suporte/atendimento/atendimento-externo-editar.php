...
//ini_set("display_errors", 1);
		...
		if(!empty($suporteId)){
			$readsuporte = read('antendimento_externo',"WHERE id = '$suporteId'");
			if(!$readsuporte){
 ...
 <div class="content-wrapper">
  <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="painel.php?execute=suporte/ouvidoria/atendimento-externo">Atendimento Externo</a></li>
  ...
  <section class="content">
	...
	$cad['tratativa_ouvidoria'] = mysql_real_escape_string($_POST['tratativa_ouvidoria']);
				...
				update('antendimento_externo',$cad,"id = '$suporteId'");	
			...
			if(isset($_POST['baixar-operacional'])){
				...
				if(in_array('',$cad)){
					...
					update('antendimento_externo',$cad,"id = '$suporteId'");	
					$_SESSION['antendimento_externo'] = '<div class="alert alert-success">Baixado com sucesso</div>';
				    header("Location: ".$_SESSION['url']);
				 }
			}
	...
	$edit['operacional_solicitacao']  = mysql_real_escape_string($_POST['operacional_solicitacao']);
				    ...
				    create('antendimento_externo',$edit);
					$_SESSION['cadastro'] = '<div class="alert alert-success">Cadastrado com sucesso</div>';
				    header("Location: ".$_SESSION['url']);
			}
			
			if(isset($_POST['deletar'])){
					$readDeleta = read('antendimento_externo',"WHERE id = '$suporteId'");
					if(!$readDeleta){
						echo '<div class="alert alert-warning">Desculpe, o registro não existe!</div><br />';
					}else{
						delete('antendimento_externo',"id = '$suporteId'");
