<?php 
	...
	if ( isset( $_POST[ 'relatorio-pdf' ] ) ) {
		...
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-atendimento-pos-venda-pdf");';
		echo '</script>';
	}
	...
	if ( isset( $_POST[ 'relatorio-excel' ] ) ) {
		...
		header( 'Location: ../admin/suporte/relatorio/relatorio-atendimento-pos-venda-excel.php' );
	}
	...
	if($leitura){
		...
		foreach($leitura as $mostra):
		 	echo '<tr>';
				...
				echo '<td>'.substr($suporteMotivo['nome'],0,25).'</td>';
		
				echo '<td>'.$mostra['status'].'</td>';
		
				if($mostra['foto']!= '' && file_exists('../uploads/atendimentos/'.$mostra['foto'])){ 
				...
				echo '<td align="center">
				<a href="painel.php?execute=suporte/atendimento/atendimento-editar&atendimentoBaixar='.$mostra['id'].'">
