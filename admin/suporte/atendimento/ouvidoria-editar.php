...
//
//		if(numeroSemana($edit['data_limite'])==6){ // sabado
//			$edit['data_limite'] =  somarDia($edit['data_limite'],3);
//		}
//		if(numeroSemana($edit['data_limite'])==0){ //domingo
//			$edit['data_limite'] =  somarDia($edit['data_limite'],2);
//		}
		...
		if(!empty($suporteId)){
			...
			$readsuporte = read('ouvidoria',"WHERE id = '$suporteId'");
			if(!$readsuporte){
 ...
 <div class="content-wrapper">
  ...
  <section class="content">
	...
	$cad['tratativa_ouvidoria'] = mysql_real_escape_string($_POST['tratativa_ouvidoria']);
				...
				update('ouvidoria',$cad,"id = '$suporteId'");	
			...
			if(isset($_POST['baixar'])){
				...
				$cad['status'] = 'OK';
				$cad['solucao'] = mysql_real_escape_string($_POST['solucao']);
				$cad['data_solucao'] = mysql_real_escape_string($_POST['data_solucao']);
				$cad['tecnico']	=  $_SESSION['autUser']['nome'];
	...
	$edit['operacional_solicitacao']  = mysql_real_escape_string($_POST['operacional_solicitacao']);
			...
			if(isset($_POST['deletar'])){
					$readDeleta = read('ouvidoria',"WHERE id = '$suporteId'");
					if(!$readDeleta){
						echo '<div class="alert alert-warning">Desculpe, o registro não existe!</div><br />';
					}else{
						delete('ouvidoria',"id = '$suporteId'");
						$_SESSION['cadastro'] = '<div class="alert alert-success">Deletado com sucesso</div>';
						header('Location: painel.php?execute=suporte/ouvidoria/ouvidorias');
					}
			 }
		?>
        ...
        <div class="row">
		   ...
		   <div class="form-group col-xs-12 col-md-12">  
                <label>Protocolo</label>
                 <input name="id" class="form-control" type="text" disabled value="<?php echo $edit['id'] . '|'.$contrato['controle'] ;?>"/>
            </div>
                  ...
                  <div class="input-group">
                       ...
                       <div class="input-group-addon">
                         <i class="fa fa-calendar"></i>
                  		...
                  		<input type="date" name="data_ouvidoria" class="form-control"  value="<?php echo $edit['data_ouvidoria'];?>" disabled />
             ...
             <div class="form-group col-xs-12 col-md-12"> 
			  ...
			  <div class="form-group col-xs-6">
                ...
                <select name="status" class="form-control" >
                  <option value="">...</option>
                  <option <?php if($edit['status'] == '1') echo' selected="selected"';?> value="1">OK</option>
                  <option <?php if($edit['status'] == '0') echo' selected="selected"';?> value="0">Aguardando</option>
                 </select>
           	 </label>
       		</div>
