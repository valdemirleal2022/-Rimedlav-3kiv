<?php 
	...
	$total = conta('pedido',"WHERE operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' AND operacional_solicitacao='1' ORDER BY data_solicitacao ASC ");

	$leitura = read('pedido',"WHERE  operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' AND operacional_solicitacao='1' ORDER BY data_solicitacao DESC, hora_solicitacao DESC");
 
	if(!empty($status)){
		$total = conta('pedido',"WHERE  operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' AND status='$status' AND operacional_solicitacao='1'");
	...
	if(!empty($suporte)){
		$total = conta('pedido',"WHERE  operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' AND id_suporte='$suporte' AND operacional_solicitacao='1'");
		$leitura = read('pedido',"WHERE  operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' AND id_suporte='$suporte' AND operacional_solicitacao='1' ORDER BY data_solicitacao ASC");
	}
		
	if(!empty($status) && !empty($suporte ) ){
		$total = conta('pedido',"WHERE  operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' 
			AND status='$status' AND  operacional_status='Aguardando'suporte='$suporte' AND operacional_solicitacao='1'");
		$leitura = read('pedido',"WHERE  operacional_status='Aguardando' AND data_solicitacao>='$data1' AND data_solicitacao<='$data2'
	...
	if($leitura){
		...
		foreach($leitura as $mostra):
		 	echo '<tr>';
				...
				echo '<td align="center">
				<a href="painel.php?execute=suporte/atendimento/pedido-editar&suporteBaixarOperacional='.$mostra['id'].'">
