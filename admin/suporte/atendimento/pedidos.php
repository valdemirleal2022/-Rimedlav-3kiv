<?php 
	...
	if(isset($_POST['pesquisar'])){
		...
		$total = conta('pedido',"WHERE id AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' ORDER BY data_solicitacao ASC");
		$leitura = read('pedido',"WHERE id AND data_solicitacao>='$data1' AND data_solicitacao<='$data2' ORDER BY data_solicitacao ASC");
                     ...
                     <form name="form-pesquisa" method="post" class="form-inline" role="form">
                         ...
                         <div class="form-group pull-left">
						  ...
						  <div class="form-group pull-left">
							 ...
							 <option <?php if($status == 'Ouvidoria') echo' selected="selected"';?> value="Ouvidoria">Ouvidoria</option>
							 </select>
						</div><!-- /.row -->
		...
		foreach($leitura as $mostra):
		 	echo '<tr>';
				...
				if($mostra['status']=='Ouvidoria'){
					...
					echo '<td align="center">
					<a href="painel.php?execute=suporte/atendimento/pedido-editar&suporteBaixar='.$mostra['id'].'">
