            ...
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <div class="box-header">
                        <a href="painel.php?execute=suporte/cadastro/cancelamento-editar" class="btnnovo">
	...
	if($leitura){
		...
		foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				<a href="painel.php?execute=suporte/cadastro/cancelamento-editar&cancelamentoEditar='.$mostra['id'].'">
			  				<img src="ico/editar.png" title="Editar" />
              			</a>
				      </td>';
				echo '<td align="center">
			  			<a href="painel.php?execute=suporte/cadastro/cancelamento-editar&cancelamentoDeletar='.$mostra['id'].'">
