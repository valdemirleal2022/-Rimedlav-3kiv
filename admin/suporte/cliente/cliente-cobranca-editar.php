<?php 
		...
		if(!empty($clienteCobrancaId)){
			...
			$readCliente = read('cliente_cobranca',"WHERE id = '$clienteCobrancaId'");
			if(!$readCliente){
		...
		if(isset($_POST['atualizar'])){
			...
			if(empty($edit['nome'])){
				echo '<div class="alert alert-warning">O Nome do cliente é obrigatório!</div>'.'<br>';
					...
					update('cliente_cobranca',$edit,"id = '$clienteCobrancaId'");
					header("Location: ".$_SESSION['url_cliente']);
				}
		}
	
	 	if(isset($_POST['deletar'])){
			$readDeleta = read('cliente_cobranca',"WHERE id = '$clienteCobrancaId'");
			if(!$readDeleta){
				echo '<div class="alert alert-warning">Desculpe, o registro não existe</div><br />';	
			 }else{
				delete('cliente_cobranca',"id = '$clienteCobrancaId'");
				header("Location: ".$_SESSION['url_cliente']);
			}
		}
