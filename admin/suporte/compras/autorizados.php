<?php
	...
	$total = conta('estoque_compras',"WHERE id AND status='Autorizado' AND compra_autorizacao='1'");
	$leitura = read('estoque_compras',"WHERE id AND status='Autorizado' AND compra_autorizacao='1' ORDER BY data_solicitacao DESC");
