<?php
	...
	$total = conta('estoque_compras',"WHERE id AND status='Comprado' AND comprado='1'");
	$leitura = read('estoque_compras',"WHERE id AND status='Comprado' AND comprado='1' ORDER BY data_solicitacao DESC");
