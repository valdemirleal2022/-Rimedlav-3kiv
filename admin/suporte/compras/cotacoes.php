<?php
	...
	$total = conta('estoque_compras',"WHERE id AND status='Cotando'");
	$leitura = read('estoque_compras',"WHERE id AND status='Cotando' ORDER BY data_solicitacao DESC");
			...
			foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				if($mostra['autorizar']=='0'){
					echo '<td align="right">'.$mostra['autorizar'].'</td>';	
