...
<?php 
	...
	$leitura = read('contrato_aditivo',"WHERE id AND aprovacao_operacional='3' ORDER BY id ASC");
	$total = conta('contrato_aditivo',"WHERE id AND aprovacao_operacional='3' ORDER BY id ASC");
...
<div class="content-wrapper">
  <section class="content-header">
       <h1>Contrato Aditivos -Liberação Operacional</h1>
         <ol class="breadcrumb">
		...
		foreach($leitura as $mostra):
		 	echo '<tr>';
				...
				echo '<td align="center">
                       <a href="painel.php?execute=suporte/contrato/contrato-aditivo-consultor&autorizarOperacional='.$mostra['id'].'">
