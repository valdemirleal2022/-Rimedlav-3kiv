	...
	<div id="abas">
		...
		<div class="nav-tabs-custom">
			...
			<ul class="nav nav-tabs">
				...
				<li class="<?php echo ($_SESSION['aba']=='2' ? " active " : " " );?>"><a href="#aba-2" data-toggle="tab">Tipo de Coleta</a>
				</li>
				<li class="<?php echo ($_SESSION['aba']=='3' ? " active " : " " );?>"><a href="#aba-3" data-toggle="tab">Ordem de Serviço</a>
				</li>
				...
				<li class="<?php echo ($_SESSION['aba']=='10' ? " active " : " " );?>"><a href="#aba-10" data-toggle="tab">Interação</a>
				</li>
...
<!-- /.CONTRATO -->
		...
		<div class="tab-pane <?php echo ($_SESSION['aba']=='1' ? " active " : " " );?>" id="aba-1">
			...
			<form name="formulario" action="" class="formulario" method="post" enctype="multipart/form-data">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Consultor/Comissao</h3>
                </div><!-- /.box-header -->
              ...
              <div class="row">
				   ...
				   <div class="form-group col-xs-12 col-md-4">
					...
					<select name="frequencia" class="form-control" <?php echo $disabled;?>/>
							<option value="">Selecione o Frequência</option>
								<?php 
...
<!-- /.Faturamento-->          
			...
			<div class="box-body">
             ...
             <div class="form-group col-xs-12 col-md-4">
                <label>Cobrança da Coleta</label>
           ...
           <div class="form-group col-xs-12 col-md-2"> 
             ...
             <div class="form-group col-xs-12 col-md-2"> 
              ...
              <div class="form-group col-xs-12 col-md-12"> 
				<label>Observação da Nota </label>
...
<!-- /.Manifesto & Cobrança-->
         	...
         	<div class="box-header with-border">
                  <h3 class="box-title">Manifesto & Cobrança</h3>
                </div><!-- /.box-header -->
			...
			<div class="box-body">
             ...
             <div class="form-group col-xs-12 col-md-3"> 
              ...
              <div class="form-group col-xs-12 col-md-3"> 
                <label>Saldo Mínimo de Etiqueta</label>
			  ...
			  <div class="col-md-12 scrool">  
				...
				if($leitura){
						echo '<table class="table table-hover">	
								...
								<td align="center">Valor Extra</td>
...
<!--          	 <div class="box-body table-responsive data-spy='scroll'">
		 	...
		 	<?php 
			  $hoje=date('Y/m/d');
			  $valorTotal = soma('receber',"WHERE id AND id_contrato = '$contratoId'",'valor');
			  $valorAtrasado = soma('receber',"WHERE id AND id_contrato = '$contratoId' 
			  						AND vencimento<'$hoje' AND status='EM ABERTO'",'valor');
			  $valorQuitado = soma('receber',"WHERE id AND id_contrato = '$contratoId' AND status<>'EM ABERTO' ",'valor');
			  $total = conta('receber',"WHERE id AND id_contrato = '$contratoId'");	
              
			  $leitura = read('receber',"WHERE id AND id_contrato = '$contratoId' ORDER BY vencimento ASC");
			    if($leitura){
					echo '<table class="table table-hover">	 
					<tr class="set">
					<td align="center">Id</td>
				...
				foreach($leitura as $mostra):
						echo '<tr>';
							...
							echo '<td align="left">'.$banco['nome']. "|".$formpag['nome'].'</td>';
							...
							echo '<td align="center">
										<a href="../cliente/painel2.php?execute=suporte/contrato/extrato-cliente-resumido&boletoId='.$mostra['id'].'" target="_blank">
											<img src="ico/extrato.png" alt="Extrato" title="Extrato"  />
										</a>
										</td>';		
					 ...
					 echo '<tfoot>';
                        ...
                        echo '<tr>';
                        echo '<td colspan="18">' . 'Total de registros : ' .  $total . '</td>';
                        echo '</tr>';
			
						echo '<tr>';
                        echo '<td colspan="18">' . 'Valor Quitado R$ : ' .converteValor($valorQuitado);
						echo '</tr>';
                       
                       	echo '<tr>';
						echo '<td colspan="18">' . 'Valor Atrasado R$ : ' .converteValor($valorAtrasado);
					  	echo '</tr>';

						echo '<tr>';
                        echo '<td colspan="18">' . 'Valor Total R$ : ' .converteValor($valorTotal);
						echo '</tr>';
...
<!-- /.Atendimento -->
		...
		<div class="tab-pane <?php echo ($_SESSION['aba']=='7' ? " active " : " " );?>" id="aba-7">
            ...
            <div class="box-header">
            	 <div class="col-xs-10 col-md-3 pull-left">  
					 <a href="painel.php?execute=suporte/pedido/pedido-editar&contratoId=<?PHP echo $contratoId; ?>" class="btnnovo">
             ...
             $leitura = read('pedido',"WHERE id AND id_contrato = '$contratoId' ORDER BY id ASC");
                  if($leitura){
					echo '<table class="table table-hover">	 
						<tr class="set">
                        <td align="center">Id</td>
                       ...
                       foreach($leitura as $pedido):
                            echo '<tr>';
								...
								echo '<td>'.$suporte['nome'].'</td>';
					  		    echo '<td>'.$pedido['solicitacao'].'</td>';
					  			echo '<td>'.converteData($pedido['data_solucao']).'</td>';
					  			echo '<td>'.$pedido['status'].'</td>';
					  		
								echo '<td align="center">
									<a href="painel.php?execute=suporte/pedido/pedido-editar&suporteEditar='.$pedido['id'].'">
												<img src="ico/editar.png" alt="Editar" title="Editar" class="tip" />
											</a>
										  </td>';
									echo '<td align="center">
									<a href="painel.php?execute=suporte/pedido/pedido-editar&suporteBaixar='.$pedido['id'].'">
												<img src="ico/baixar.png" alt="Baixar" title="Baixar" class="tip" />
											</a>
										  </td>';
				...
				if($leitura){
					...
					foreach($leitura as $contratoBaixa):
						...
						echo '<tr>';
							...
							if($contratoBaixa['tipo']=='2'){
								echo '<td align="left">'.converteData($edit['data_suspensao']).'</td>';
							}elseif($contratoBaixa['tipo']=='5'){
								echo '<td align="left">'.converteData($edit['data_cancelamento']).'</td>';
							}else{
								echo '<td align="left">-</td>';
							}
						echo '<td align="left">'.resumos($contratoBaixa['motivo'],$palavras = '70') .'</td>';
...
<!-- /.INTERACOES -->
		...
		<div class="tab-pane <?php echo ($_SESSION['aba']=='10' ? " active " : " " );?>" id="aba-10">
			...
			<div class="box-header with-border">
                 <h3 class="box-title">Interaçoes</h3>
             </div><!-- /.box-header -->
         	...
         	<div class="box-header">
				  ...
				  <div class="form-group pull-left">
					<form name="form" action="" method="post" enctype="multipart/form-data">
					   <input type="file" name="arquivo">
					   <br><br>
					  <input type="submit" name="pdf-assinatura" value="Upload de Assinatura PDF class="btn btn-primary"/>
