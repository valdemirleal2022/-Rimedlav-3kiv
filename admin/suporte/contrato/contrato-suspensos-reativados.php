 ...
 <?php 
	...
	if(isset($_POST['relatorio-pdf'])){
		...
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-contrato-suspensos-temporario-ativos-pdf");';
		echo '</script>';
...
<div class="content-wrapper">
  <section class="content-header">
       <h1>Contratos Suspensos Reativados </h1>
         <ol class="breadcrumb">
		...
		if($leituraBaixa ){
			...
			foreach($leituraBaixa as $contratoBaixa);
		 	...
		 	echo '<tr>';
				...
				echo '<td align="right">'.converteValor($contratoColeta['valor_mensal']).'</td>';
			    ...
			    echo '<td align="center">
			  			<a href="painel.php?execute=suporte/faturamento/extrato-cliente-suspenso-reativados&contratoId='.$contrato['id'].'" target="_blank">
