...
<?php 
	 ...
	 $leitura = read('email',"WHERE id ORDER BY data ASC LIMIT 200");
		...
		$link1="https://www.cleanambiental.com.br/orcamento-coleta";
		$link2="https://www.cleanambiental.com.br/admin/painel2.php?execute=suporte/email/email-cancelar&clienteId=".$id;
		$assunto = $email_mkt['titulo'];
		$msg = "<font size='2px' face='Verdana, Geneva, sans-serif' color='#444'>";
		$msg .="<img src='https://www.cleanambiental.com.br/site/images/header-logo.png'> <br />";
		...
		$emailEnvio='vendas@cleanambiental.com.br';
