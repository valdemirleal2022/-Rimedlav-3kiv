<?php
	...
	$total = conta('estoque_equipamento_manutencao',"WHERE id AND status='Em aberto'");
	$leitura = read('estoque_equipamento_manutencao',"WHERE id AND status='Em aberto' ORDER BY data_entrega ASC");
	...
	if ( isset( $_POST[ 'relatorio-pdf' ] ) ) {
		...
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-equipamento-manutencao-pdf");';
		echo '</script>';
	}
	...
	if ( isset( $_POST[ 'relatorio-excel' ] ) ) {
		...
		$_SESSION['fim']=$data2;
		$_SESSION['tipo']=$tipo;
		header( 'Location: ../admin/suporte/relatorio/relatorio-equipamento-manutencao-excel.php' );
	}
	...
	if ( isset( $_POST[ 'pesquisar' ] ) ) {
		...
		$total = conta('estoque_equipamento_manutencao',"WHERE id AND data_entrega>='$data1' 
					 AND data_entrega<='$data2' AND status='Em aberto'");
		$leitura = read('estoque_equipamento_manutencao',"WHERE id AND data_entrega>='$data1' 
...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Solicitação Manutenção/Fabricação</h1>
		<ol class="breadcrumb">
                     ...
                     <form name="form-pesquisa" method="post" class="form-inline" role="form">
						 ...
						 <div class="form-group pull-left">
								<select name="tipo" class="form-control input-sm">
								  ...
								  <option <?php if($tipo == '3') echo' selected="selected"';?> value="3">manutencao</option>
							    </select>
						   </div> 
			...
			foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				echo '<td align="center">
						<a href="painel.php?execute=suporte/estoque/equipamento-manutencao-editar&manutencaoEditar='.$mostra['id'].'">
			  				<img src="ico/editar.png" alt="Editar" title="Editar" />
              			</a>
				      </td>';
				
				echo '<td align="center">
						<a href="painel.php?execute=suporte/estoque/equipamento-manutencao-editar&manutencaoBaixar='.$mostra['id'].'">
			  				<img src="ico/baixar.png" alt="Baixar" title="Baixar" />
              			</a>
				      </td>';
				
				echo '<td align="center">
			  			<a href="painel.php?execute=suporte/estoque/equipamento-manutencao-editar&manutencaoDeletar='.$mostra['id'].'">
