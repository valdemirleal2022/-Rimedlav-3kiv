...
<div class="content-wrapper">
	...
	<section class="content">
			...
			<div class="col-md-12">
				<div class="box box-default">
					...
					<div class="box-header">
						<a href="painel.php?execute=suporte/estoque/equipamento-reposicao-editar" class="btnnovo">
		...
		<div class="box-body table-responsive">
			...
			$total = conta('estoque_equipamento_reposicao',"WHERE id");
			$leitura = read('estoque_equipamento_reposicao',"WHERE id ORDER BY data DESC LIMIT $inicio,$maximo");
			if($leitura){
			...
			foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				<a href="painel.php?execute=suporte/estoque/equipamento-reposicao-editar&reposicaoEditar='.$mostra['id'].'">
			  				<img src="ico/editar.png" alt="Editar" title="Editar" class="tip" />
              			</a>
				      </td>';
				
				echo '<td align="center">
			  			<a href="painel.php?execute=suporte/estoque/equipamento-reposicao-editar&reposicaoDeletar='.$mostra['id'].'">
		...
		$link = 'painel.php?execute=suporte/estoque/equipamento-reposicao&pag=';
	     pag('estoque_equipamento_reposicao',"WHERE id ORDER BY data DESC", $maximo, $link, $pag);
