<?php 
	...
	if ( isset( $_POST[ 'relatorio-pdf' ] ) ) {
		...
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-etiquetas-pdf");';
		echo '</script>';
	}
	...
	if ( isset( $_POST[ 'relatorio-excel' ] ) ) {
		...
		$data1=$_POST['inico'];
		$data2=$_POST['fim'];
		header( 'Location: ../admin/suporte/relatorio/relatorio-etiquetas-excel.php' );
	}

	
 	$leitura = read('estoque_etiqueta',"WHERE id ORDER BY nome ASC");
   ...
   <div class="col-md-12">  
     <div class="box box-default">
			 ...
			 <div class="box-header">
				<a href="painel.php?execute=suporte/estoque/etiqueta-editar" class="btnnovo">
				  <img src="ico/novo.png" alt="Criar Novo" title="Criar Novo" class="tip" />
				  <smal> Novo Etiqueta </smal>
				 </a>
			</div><!-- /.box-header -->
		...
		foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				echo '<td align="center">
					<a href="painel.php?execute=suporte/estoque/etiqueta-editar&etiquetaEditar='.$mostra['id'].'">
			  				<img src="ico/editar.png" alt="Editar" title="Editar" class="tip" />
              			</a>
				      </td>';
			
				echo '<td align="center">
			  			<a href="painel.php?execute=suporte/estoque/etiqueta-editar&etiquetaDeletar='.$mostra['id'].'">
