<?php 
		...
		if(!empty($_GET['manutencaoId'])){
			$manutencaoId = $_GET['manutencaoId'];
			$acao = "cadastrar";
		}
  ...
  <section class="content">
     ...
     <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><small><?php echo $edit['id'];?></small></h3>
             	<div class="box-tools">
            		<small>
	...
	if(isset($_POST['cadastrar'])){
		...
		$cad['id_manutencao']=$manutencaoId;
		...
		if(in_array('',$cad)){
			...
			unset($cad);
			//header("Location: ".$_SESSION['manunutencao-editar']);
		}
	}
         ...
         <div class="form-group col-xs-12 col-md-6">  
            <label>Material</label>
                <select name="id_material" class="form-control" >
                    ...
                    <?php 
                        $readConta = read('estoque_material',"WHERE id ORDER BY codigo ASC");
                        if(!$readConta){
