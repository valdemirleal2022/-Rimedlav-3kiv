<?php 
	...
	$leitura = read( 'contrato_ordem', "WHERE id AND data='$dataroteiro' 
						ORDER BY data DESC, hora ASC LIMIT $inicio,$maximo" );
	...
	if($leitura){
		...
		foreach($leitura as $mostra):
		 	echo '<tr>';
				...
				$endereco[$contador] = $cliente['endereco'].', '.$cliente['numero'].' -'.$cliente['bairro'].', '.$cliente['cidade'];
...
<section class="content">
  <div class="box box-warning">
     <div class="box-body">    
		   ...
		   <div class="col-md-4" id="trajeto-texto" >  
