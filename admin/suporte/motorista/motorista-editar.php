<?php 
		...
		if(!empty($_GET['motoristaVisualizar'])){
			$motoristaId = $_GET['motoristaVisualizar'];
			$acao = "visualizar";
		}
  ...
  <section class="content">
	...
	<?php 
		...
		if(in_array('',$cad)){
			...
			header('Location: painel.php?execute=suporte/motorista/motoristas');
			unset($cad);
		}
	}
  	...
  	<div class="box box-warning">
     	 <div class="box-body">
             <div class="box-header">
				 ...
				 <a href="painel.php?execute=suporte/motorista/negligencia-editar&motoristaId=<?PHP echo $motoristaId; ?>" class="btnnovo">
					<img src="../admin/ico/novo.png" title="Criar Novo" />
				 </a>	
				 <small> Negligência  </small>
          	</div><!-- /box-tools-->
         
 <?php 
      		
       $leitura = read('veiculo_motorista_negligencia',"WHERE id AND id_motorista = '$motoristaId' ORDER BY id ASC");
                  if($leitura){
                            ...
                            echo '<tr>';
                              ...
                              echo '<td>'.$mostra['id'].'</td>';
								...
								echo '<td>'.$negligencia['nome'].'</td>';
					  			echo '<td>'.$negligencia['pontuacao'].'</td>';
