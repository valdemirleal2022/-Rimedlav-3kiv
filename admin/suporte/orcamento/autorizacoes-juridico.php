...
<?php 
	...
	$valor_total = soma('cadastro_visita',"WHERE id AND aprovacao_juridico='3'",'orc_valor');

 	$total = conta('cadastro_visita',"WHERE id AND aprovacao_juridico='3'");
	
	$leitura = read('cadastro_visita',"WHERE id AND aprovacao_juridico='3' ORDER BY orc_data DESC");


	if ( isset( $_POST[ 'relatorio-pdf' ] ) ) {
		
		$aprovacao_juridico = $_POST['aprovacao_juridico'];
		$_SESSION['aprovacao_juridico']=$aprovacao_juridico;

		echo '<script type="text/javascript">';
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-autorizacoes-juridico-pdf");';
		echo '</script>';
	}
	...
	if ( isset( $_POST[ 'relatorio-excel' ] ) ) {
		...
		header( 'Location: ../admin/suporte/relatorio/relatorio-autorizacoes-juridico-excel.php' );
	}
	
	if(isset($_POST['pesquisar'])){
		$aprovacao_juridico = $_POST['aprovacao_juridico'];
		
		$valor_total = soma('cadastro_visita',"WHERE id AND aprovacao_juridico='$aprovacao_juridico'",'orc_valor');

 		$total = conta('cadastro_visita',"WHERE id AND aprovacao_juridico='$aprovacao_juridico'");
		
		$leitura = read('cadastro_visita',"WHERE id AND aprovacao_juridico='$aprovacao_juridico' ORDER BY orc_data DESC");
...
<div class="content-wrapper">
  ...
  <section class="content-header">
       <h1>Autoriza&ccedil;&otilde;es Juridico</h1>
         <ol class="breadcrumb">
  ...
  <div class="row">
   <div class="col-md-12">  
                  ...
                  <div class="col-xs-10 col-md-4 pull-right">
                     <form name="form-pesquisa" method="post" class="form-inline" role="form">
                           ...
                           <div class="form-group pull-left">
								<select name="aprovacao_juridico" class="form-control input-sm"> <?php echo $aprovacao_juridico;?> >
								  <option value="">Selecione solicita&ccedil;&atilde;o</option>
								  <option <?php if($aprovacao_juridico == '1') echo' selected="selected"';?> value="1" >Aprovado</option>
								  <option <?php if($aprovacao_juridico == '2') echo' selected="selected"';?> value="2" >N&atilde;o Autorizado</option>
								  <option <?php if($aprovacao_juridico == '3') echo' selected="selected"';?> value="3">Aguardando</option>
							 </select>
							</div> 
    ...
    <div class="box-body table-responsive data-spy='scroll'">
		...
		$pdf='../uploads/contrato-assinados/'.$mostra['id'].'.pdf';
				if(file_exists($pdf)){
					echo '<td align="center">
						<a href="../uploads/contrato-assinados/'.$mostra['id'].'.pdf" target="_blank">
				...
				$pdf='../uploads/contrato-social/'.$mostra['id'].'.pdf';
				if(file_exists($pdf)){
					echo '<td align="center">
						<a href="../uploads/contrato-social/'.$mostra['id'].'.pdf" target="_blank">
				...
				$pdf='../uploads/contrato-identidade-socio/'.$mostra['id'].'.pdf';
				if(file_exists($pdf)){
					echo '<td align="center">
						<a href="../uploads/contrato-identidade-socio/'.$mostra['id'].'.pdf" target="_blank">
				...
				echo '<td align="center">
					<a href="painel.php?execute=suporte/orcamento/orcamento-editar&autorizarJuridico='.$mostra['id'].'">
