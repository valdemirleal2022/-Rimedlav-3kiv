<?php 
	...
	if(isset($_POST['pesquisar'])){
		...
		$valor_total = soma('receber',"WHERE desconto_data>='$data1' AND desconto_data<='$data2' AND desconto_autorizar='1' AND desconto_autorizacao='1'",'desconto_valor');

		$total = conta('receber',"WHERE desconto_data>='$data1' AND desconto_data<='$data2' AND desconto_autorizar='1' AND desconto_autorizacao='1'");
		
		$leitura = read('receber',"WHERE desconto_data>='$data1' AND desconto_data<='$data2' AND desconto_autorizar='1' AND desconto_autorizacao='1' ORDER BY desconto_data");
...
<div class="content-wrapper">
  ...
  <section class="content-header">
     <h1>Desconto Próximo Faturamento</h1>
     <ol class="breadcrumb">
     	<li>Home</a>
     	<li>Receber</a>
