<?php 
	...
	$valor_total = soma('receber',"WHERE serasa='1'",'valor');
	$total = conta('receber',"WHERE serasa='1'");
	$leitura = read('receber',"WHERE serasa='1' ORDER BY serasa_data DESC");
	...
	if ( isset( $_POST[ 'relatorio-pdf' ] ) ) {
		...
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-receita-serasa-pdf");';
		echo '</script>';
	}
	...
	if ( isset( $_POST[ 'relatorio-excel' ] ) ) {
			...
			$_SESSION['inicio']=$data1;
			$_SESSION['fim']=$data2;
			header( 'Location: ../admin/suporte/relatorio/relatorio-receita-serasa-excel.php' );
	}
     ...
     <div class="box box-default">
		  ...
		  <div class="row">
			   ...
			   <div class="box-header">
					<a href="painel.php?execute=suporte/receber/aviso-serasa" class="btnnovo">
						<img src="ico/email.png" alt="Aviso de Débito" title="Aviso de Débito" class="tip" />
						 <small>Aviso do Serasa</small>
					</a>
			  </div><!-- /box-header-->
	...
	if($leitura){
		...
		foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				echo '<td align="center">'.converteData($mostra['serasa_data']).'</td>';
