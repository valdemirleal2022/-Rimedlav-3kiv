...
if($leitura AND !empty($compras['fornecedor1']) ){
...
if($leitura AND !empty($compras['fornecedor2']) ){
	...
	$pdf->SetX(110);
	$pdf->Cell(20, 5, 'Desconto (%) : '. $compras['fornecedor2_desconto']);

	$pdf->SetX(155);
	$pdf->Cell(20, 5, 'Cond Pagamento  : '. $compras['fornecedor2_pag']);

	$pdf->SetX(220);
	$pdf->Cell(20, 5, 'Prazo de Entrega  : '. $compras['fornecedor2_prazo']);
...
if($leitura AND !empty($compras['fornecedor3']) ){	
	...
	$pdf->SetX(05);
	$pdf->Cell(20, 5, 'Fornecedor 3 : ' .substr($fornecedor['nome'],0,30));

	$pdf->SetX(110);
	$pdf->Cell(20, 5, 'Desconto (%) : '. $compras['fornecedor3_desconto']);

	$pdf->SetX(155);
	$pdf->Cell(20, 5, 'Cond Pagamento  : '. $compras['fornecedor3_pag']);

	$pdf->SetX(220);
	$pdf->Cell(20, 5, 'Prazo de Entrega  : '. $compras['fornecedor3_prazo']);
