...
$total = conta('conta',"WHERE id AND pagamento>='$data1' AND pagamento<='$data2' AND status='Baixado' ORDER BY pagamento ASC");

$leitura = read('receber',"WHERE id AND conta>='$data1' AND pagamento<='$data2' AND status='Baixado' ORDER BY pagamento ASC");
