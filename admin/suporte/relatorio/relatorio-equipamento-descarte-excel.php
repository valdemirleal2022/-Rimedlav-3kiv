...
$total = conta('estoque_equipamento_retirada',"WHERE id AND bom_estado='2' AND data_entrega>='$data1' 
					 AND data_entrega<='$data2'");
$leitura = read('estoque_equipamento_retirada',"WHERE id AND bom_estado='2' AND data_entrega>='$data1' 
