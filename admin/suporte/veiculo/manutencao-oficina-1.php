  ...
  <section class="content">
	...
	<?php 
		...
		if(isset($_POST['iniciar'])){
			...
			$cad['inicio1'] = mysql_real_escape_string($_POST['inicio1']);
			$edit['inicio1'] = mysql_real_escape_string($_POST['inicio1']);
		
			$senha = mysql_real_escape_string($_POST['senha']);
			$cad['responsavel1'] = mysql_real_escape_string($_POST['responsavel1']);
			$responsavel = $cad['responsavel1'];
		...
		if(isset($_POST['baixar'])){
			...
			$senha = mysql_real_escape_string($_POST['senha']);
			$responsavel = $edit['responsavel1'];
		 	$readResponsavel = read('veiculo_manutencao_responsavel',"WHERE id = '$responsavel' AND senha = '$senha'");
	 
			$cad['reparo1'] = htmlspecialchars(mysql_real_escape_string($_POST['reparo1']));
			$cad['termino1'] = mysql_real_escape_string($_POST['termino1']);
			$cad['status1'] = 2;
			
			$edit['termino1'] = $cad['termino1'];
			$edit['reparo1'] = $cad['reparo1'];
			
			if(in_array('',$cad)){
				
				echo '<div class="alert alert-warning">Selecione Data e Hora de Termino e Descrição!</div>';
				
			}else if( empty($cad['termino1']) ){
				
				echo '<div class="alert alert-warning">Digite Descrição do Reparo!</div>';
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-12 col-md-12"> 
              <label>Descrição (*)</label>
                <textarea name="descricao1" rows="2" cols="100" class="form-control"  <?php echo $readonly;?> disabled/><?php echo $edit['descricao1'];?></textarea>
         </div>  
		  
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Responsável pela excecução</label>
                <select name="responsavel1" class="form-control"  disabled>
		   ...
		   <div class="form-group col-xs-12 col-md-4">  
            <label>Tipo de Manutenção</label>
                <select name="tipo1" class="form-control" disabled>
		 	...
		 	<div class="form-group col-xs-12 col-md-4" > 
			  <label>Status </label>
				<select name="status1" class="form-control" disabled>
