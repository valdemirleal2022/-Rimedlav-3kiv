  ...
  <section class="content">
	...
	<?php 
		...
		if(isset($_POST['iniciar'])){
			...
			$cad['inicio2'] = mysql_real_escape_string($_POST['inicio2']);
			$edit['inicio2'] = mysql_real_escape_string($_POST['inicio2']);
		
			$senha = mysql_real_escape_string($_POST['senha']);
			$cad['responsavel2'] = mysql_real_escape_string($_POST['responsavel2']);
			$responsavel = $cad['responsavel2'];
		...
		if(isset($_POST['baixar'])){
			...
			$responsavel = $edit['responsavel2'];
		 	$readResponsavel = read('veiculo_manutencao_responsavel',"WHERE id = '$responsavel' AND senha = '$senha'");
	 
			$cad['reparo2'] = htmlspecialchars(mysql_real_escape_string($_POST['reparo2']));
			$cad['termino2'] = mysql_real_escape_string($_POST['termino2']);
			$cad['status1'] = 2;
			
			$edit['termino2'] = $cad['termino2'];
			$edit['reparo2'] = $cad['reparo2'];
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-12 col-md-12"> 
              <label>Descrição (*)</label>
                <textarea name="descricao2" rows="2" cols="100" class="form-control"  <?php echo $readonly;?> disabled/><?php echo $edit['descricao2'];?></textarea>
         </div>  
		  
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Responsável pela excecução</label>
                <select name="responsavel2" class="form-control"  disabled>
		   ...
		   <div class="form-group col-xs-12 col-md-4">  
            <label>Tipo de Manutenção</label>
                <select name="tipo2" class="form-control" disabled>
		 	...
		 	<div class="form-group col-xs-12 col-md-4" > 
			  <label>Status </label>
				<select name="status2" class="form-control" disabled>
