  ...
  <section class="content">
	...
	<?php 
		...
		if(isset($_POST['iniciar'])){
			...
			$cad['inicio3'] = mysql_real_escape_string($_POST['inicio3']);
			$edit['inicio3'] = mysql_real_escape_string($_POST['inicio3']);
		
			$senha = mysql_real_escape_string($_POST['senha']);
			$cad['responsavel3'] = mysql_real_escape_string($_POST['responsavel3']);
			$responsavel = $cad['responsavel3'];
		...
		if(isset($_POST['baixar'])){
			...
			$responsavel = $edit['responsavel3'];
		 	$readResponsavel = read('veiculo_manutencao_responsavel',"WHERE id = '$responsavel' AND senha = '$senha'");
	 
			$cad['reparo3'] = htmlspecialchars(mysql_real_escape_string($_POST['reparo3']));
			$cad['termino3'] = mysql_real_escape_string($_POST['termino3']);
			$cad['status3'] = 2;
			
			$edit['termino3'] = $cad['termino3'];
			$edit['reparo3'] = $cad['reparo3'];
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-12 col-md-12"> 
              <label>Descrição (*)</label>
                <textarea name="descricao3" rows="2" cols="100" class="form-control"  <?php echo $readonly;?> disabled/><?php echo $edit['descricao3'];?></textarea>
         </div>  
		  
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Responsável pela excecução</label>
                <select name="responsavel3" class="form-control"  disabled>
		   ...
		   <div class="form-group col-xs-12 col-md-4">  
            <label>Tipo de Manutenção</label>
                <select name="tipo3" class="form-control" disabled>
		 	...
		 	<div class="form-group col-xs-12 col-md-4" > 
			  <label>Status </label>
				<select name="status3" class="form-control" disabled>
