  ...
  <section class="content">
	...
	<?php 
		...
		if(isset($_POST['iniciar'])){
			...
			$cad['inicio4'] = mysql_real_escape_string($_POST['inicio4']);
			$edit['inicio4'] = mysql_real_escape_string($_POST['inicio4']);
		
			$senha = mysql_real_escape_string($_POST['senha']);
			$cad['responsavel4'] = mysql_real_escape_string($_POST['responsavel4']);
			$responsavel = $cad['responsavel4'];
		...
		if(isset($_POST['baixar'])){
			...
			$responsavel = $edit['responsavel4'];
		 	$readResponsavel = read('veiculo_manutencao_responsavel',"WHERE id = '$responsavel' AND senha = '$senha'");
	 
			$cad['reparo4'] = htmlspecialchars(mysql_real_escape_string($_POST['reparo4']));
			$cad['termino4'] = mysql_real_escape_string($_POST['termino4']);
			$cad['status4'] = 2;
			
			$edit['termino4'] = $cad['termino4'];
			$edit['reparo4'] = $cad['reparo4'];
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-12 col-md-12"> 
              <label>Descrição (*)</label>
                <textarea name="descricao4" rows="2" cols="100" class="form-control"  <?php echo $readonly;?> disabled/><?php echo $edit['descricao4'];?></textarea>
         </div>  
		  
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Responsável pela excecução</label>
                <select name="responsavel4" class="form-control"  disabled>
		   ...
		   <div class="form-group col-xs-12 col-md-4">  
            <label>Tipo de Manutenção</label>
                <select name="tipo4" class="form-control" disabled>
		 	...
		 	<div class="form-group col-xs-12 col-md-4" > 
			  <label>Status </label>
				<select name="status4" class="form-control" disabled>
