  ...
  <section class="content">
	...
	<?php 
		...
		if(isset($_POST['iniciar'])){
			...
			$cad['inicio5'] = mysql_real_escape_string($_POST['inicio5']);
			$edit['inicio5'] = mysql_real_escape_string($_POST['inicio5']);
		
			$senha = mysql_real_escape_string($_POST['senha']);
			$cad['responsavel5'] = mysql_real_escape_string($_POST['responsavel5']);
			$responsavel = $cad['responsavel5'];
		...
		if(isset($_POST['baixar'])){
			...
			$responsavel = $edit['responsavel5'];
		 	$readResponsavel = read('veiculo_manutencao_responsavel',"WHERE id = '$responsavel' AND senha = '$senha'");
	 
			$cad['reparo5'] = htmlspecialchars(mysql_real_escape_string($_POST['reparo5']));
			$cad['termino5'] = mysql_real_escape_string($_POST['termino5']);
			$cad['status5'] = 2;
			
			$edit['termino5'] = $cad['termino5'];
			$edit['reparo5'] = $cad['reparo5'];
        ...
        <div class="row">
          ...
          <div class="form-group col-xs-12 col-md-12"> 
              <label>Descrição (*)</label>
                <textarea name="descricao5" rows="2" cols="100" class="form-control"  <?php echo $readonly;?> disabled/><?php echo $edit['descricao5'];?></textarea>
         </div>  
		  
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Responsável pela excecução</label>
                <select name="responsavel5" class="form-control"  disabled>
		   ...
		   <div class="form-group col-xs-12 col-md-4">  
            <label>Tipo de Manutenção</label>
                <select name="tipo5" class="form-control" disabled>
		 	...
		 	<div class="form-group col-xs-12 col-md-4" > 
			  <label>Status </label>
				<select name="status5" class="form-control" disabled>
