...
<section class="content">
  <div class="row">
   <div class="col-md-12">  
	...
	if ($_SESSION['parcial']=="checked='CHECKED'") {
	...
	if($leitura){
		...
		foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				<a href="painel.php?execute=suporte/veiculo/motorista-editar&motoristaEditar='.$mostra['id'].'">
			  				<img src="ico/editar.png" alt="Editar" title="Editar" class="tip" />
              			</a>
				      </td>';
				echo '<td align="center">
			  			<a href="painel.php?execute=suporte/veiculo/motorista-editar&motoristaDeletar='.$mostra['id'].'">
