<?php 
	...
	if ( isset( $_POST[ 'relatorio-pdf' ] ) ) {
		...
		$consultorId=strip_tags(trim(mysql_real_escape_string($_POST['consultor'])));
		$_SESSION['inicio']=$data1;
		$_SESSION['fim']=$data2;
		$_SESSION['consultor']=$consultorId;
		echo '<script type="text/javascript">';
		echo 'window.open("painel.php?execute=suporte/relatorio/relatorio-comissao-pdf");';
		echo '</script>';
	}
	...
	if ( isset( $_POST[ 'relatorio-excel' ] ) ) {
		...
		$_SESSION['inicio']=$data1;
		$_SESSION['fim']=$data2;
		header( 'Location: ../admin/suporte/relatorio/relatorio-comissao-excel.php' );
	}
	...
	if ( isset( $_POST[ 'relatorio-geral-excel' ] ) ) {
		...
		$_SESSION['inicio']=$data1;
		$_SESSION['fim']=$data2;
		header( 'Location: ../admin/suporte/relatorio/relatorio-comissao-geral-excel.php' );
	}
   ...
   <div class="col-md-12">  
	...
	if($leitura){
		...
		echo '<tfoot>';
		  ...
		  echo '<tr>';
           echo '<td colspan="14">' . 'Total Recebido R$ : '.converteValor($valor_total).'</td>';
		  echo '</tr>';
		
		 echo '<tr>';
           echo '<td colspan="14">' . 'Total Comissão R$ : '.converteValor($valor_comissao).'</td>';
		  echo '</tr>';
