...
<?php 
	...
	if (($vencimento < date('Y-m-d'))) {
		...
		if($dias<3){
			$diasemana_numero = date('w', strtotime($vencimento_original));
	...
	//if(empty($boleto['imprimir'])){
//		$assunto = "Cliente Gerou Boleto - " . $cliente['nome'];
//		$msg = "<font size='2 px' face='Verdana, Geneva, sans-serif' color='#000099'>";
//		$msg .= "Cliente : " . $cliente['nome'] . "<br />";
//		$msg .= "Nosso Numero : " . $boleto['id'] . "<br />";
//		$msg .= "Data de Vencimento : " . $vencimento . "<br />";
//		$msg .= "Valor R$  : " .  $valor . "<br />";
//		$msg .=  "</font>";
...
//	 
	...
	$instrucoes3='Após 60 dias em atraso, o boleto será automaticamente Protestado.';
...
<meta charset="iso-8859-1">
    <title>WPC Sistema Integrado - Imprimir Boleta</title>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="linha_dir"><?PHP echo $nossonumero; ?></td>
