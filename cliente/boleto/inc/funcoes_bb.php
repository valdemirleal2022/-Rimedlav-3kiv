...
if ($dadosboleto["formatacao_convenio"] == "6") {
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "2") {
		...
		$dv = modulo_11("$codigobanco$nummoeda$fator_vencimento$valor$convenio$nossonumero$ncontrato");
		$linha = "$codigobanco$nummoeda$dv$fator_vencimento$valor$convenio$nossonumero$ncontrato";
	}
}
