...
$carteira = formata_numero(trim($dadosboleto["carteira"]),2,0);

//nosso número (sem dv) é 11 digitos
$nnum = formata_numero(trim($dadosboleto["nosso_numero"]),11,0);

//dv do nosso número
$dv_nosso_numero = digitoVerificador_nossonumero($carteira.$nnum);
...
$nossonumero = $carteira.'/'.$nnum.'-'.$dv_nosso_numero;
$nossonumero = $carteira.'/'.$nnum.'-'.$dv_nosso_numero;
