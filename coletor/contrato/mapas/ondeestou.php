   ...
   <div class="col-md-12">  
    ...
    <div class="box-body table-responsive">
          ...
          <?php 
			...
			$telefone = $mostrarota['telefone'];
			$latitude = $mostrarota['latitude'];
			$longitude = $mostrarota['longitude'];
			$data = date('d/m/Y H:i:s',strtotime($mostrarota['data']));
			 
			echo '<div class="col-xs-10 col-md-4 pull-left">';
				if($mostrarota['fotoperfil'] != '' && file_exists('../uploads/rotas/'.$mostrarota['fotoperfil'])){
					echo '<img src="../uploads/rotas/'.$mostrarota['fotoperfil'].'"  class="img-circle"/>';
				}else{
