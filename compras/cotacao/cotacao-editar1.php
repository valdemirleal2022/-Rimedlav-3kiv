	 ...
	 <div class="form-group col-xs-12 col-md-12">  
		 ...
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Fornecedor</label>
                <select name="fornecedor1" class="form-control" disabled>
		...
		<div class="box-body table-responsive">
			...
			foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				$total = $mostra['quantidade']*$mostra['valor1'];
				...
				echo '<td align="center">
			  			<a href="painel2.php?execute=cotacao/cotacao-material-editar1&cotacaoMaterialEditar='.$mostra['id'].'">
		 ...
		 endforeach;
		  ...
		  echo '<tfoot>';
				...
				$desconto=($totalGeral*$edit['fornecedor1_desconto'])/100;
