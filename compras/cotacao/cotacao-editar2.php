	 ...
	 <div class="form-group col-xs-12 col-md-12">  
		 ...
		 <div class="form-group col-xs-12 col-md-4">  
            <label>Fornecedor</label>
                <select name="fornecedor2" class="form-control" disabled>
		...
		<div class="box-body table-responsive">
			...
			foreach($leitura as $mostra):
		 	...
		 	echo '<tr>';
				...
				$total = $mostra['quantidade']*$mostra['valor2'];
				...
				echo '<td align="center">
			  			<a href="painel2.php?execute=cotacao/cotacao-material-editar2&cotacaoMaterialEditar='.$mostra['id'].'">
		 ...
		 endforeach;
		  ...
		  echo '<tfoot>';
				...
				$desconto=($totalGeral*$edit['fornecedor2_desconto'])/100;
