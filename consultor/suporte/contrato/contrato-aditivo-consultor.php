<?php 
		...
		if(!empty($_GET['Visualizar'])){
			$contratoAditivoId = $_GET['Visualizar'];
			$acao = "visualizar";
		}
		...
		if ( !empty( $_GET[ 'autorizarOperacional' ] ) ) {
			$contratoAditivoId = $_GET[ 'autorizarOperacional' ];
		...
		if ( !empty( $_GET[ 'autorizarComercial' ] ) ) {
			$contratoAditivoId = $_GET[ 'autorizarComercial' ];
	...
	?>
  	...
  	<form name="formulario" action="" class="formulario" method="post" enctype="multipart/form-data">
		 ...
		 <div class="form-group col-xs-12 col-md-6"> 
					...
					<input type="text" name="endereco" value="<?php echo $edit['endereco'];?>"  class="form-control" readonly >
		</div> 
					 
		 <div class="form-group col-xs-12 col-md-6"> 
					<label>Endereco (Aditivo) </label>
					<input type="text" name="endereco_aditivo" value="<?php echo $edit['endereco_aditivo'];?>"  class="form-control" >
		</div> 
				  
		 <div class="form-group col-xs-12 col-md-6"> 
					<label>Frequencia </label>
					<input type="text" name="frequencia" value="<?php echo $edit['frequencia'];?>"  class="form-control" readonly >
		</div> 
		 <div class="form-group col-xs-12 col-md-6"> 
	  ...
	  <div class="form-group col-xs-12 col-md-6">  
                      ...
                      <select name="tipo_coleta"  class="form-control" readonly >
		 ...
		 <div class="form-group col-xs-12 col-md-6"> 
					...
					<input type="text" name="quantidade" value="<?php echo $edit['quantidade'];?>"  class="form-control" readonly>
		</div> 
		 ...
		 <div class="form-group col-xs-12 col-md-6"> 
					...
					<input type="text" name="valor_unitario" value="<?php echo converteValor($edit['valor_unitario']);?>"  class="form-control" readonly >
		</div> 
		 ...
		 <div class="form-group col-xs-12 col-md-6"> 
					...
					<input type="text" name="valor_extra" value="<?php echo converteValor($edit['valor_extra']);?>"  class="form-control" readonly >
		</div> 
		...
		<div class="form-group col-xs-12 col-md-6"> 
					...
					<input type="text" name="valor_mensal" value="<?php echo converteValor($edit['valor_mensal']);?>"  class="form-control" readonly >
		</div> 	
		...
		<div class="form-group col-xs-12 col-md-6"> 
		 ...
		 <div class="form-group col-xs-12 col-md-6"> 
					<label>Rota </label>
					<input type="text" name="rota" value="<?php echo $edit['rota'] ;?>"  class="form-control" readonly >
		</div> 
                    ...
                    <div class="box-body">
                       <div class="row">  
							...
							<div class="form-group col-xs-12 col-md-12">
                                ...
                                <input type="text" name="aprovacao_comercial_observacao" value="<?php echo $edit['aprovacao_comercial_observacao'];?>" class="form-control"   />
                            </div>
                  ...
                  <div class="box-body">
                       <div class="row">  
                          ...
                          <div class="form-group col-xs-3">
                             ...
                             <div class="form-group col-xs-12 col-md-2">  
                               <label>Rota </label>
							  <select name="rota_aditivo"  class="form-control">
                             ...
                             <div class="form-group col-xs-12 col-md-2">
                                <label>Hora </label>
                                <input type="text" name="hora_aditivo" value="<?php echo $edit['hora_aditivo'];?>" class="form-control" />
                            </div>
                            
                            <!-- aprovacao_comercial-->
							<div class="form-group col-xs-12 col-md-12">
                                <label>Observação </label>
                                <input type="text" name="aprovacao_operacional_observacao" value="<?php echo $edit['aprovacao_operacional_observacao'];?>" class="form-control" />
                            </div>
       	  ...
       	  <div class="box-footer">
				 ...
				 <?php 
					...
					if($acao=="deletar"){
					  ...
					  echo '<input type="submit" name="autorizarComercial" value="Autorizar Aditivo" class="btn btn-primary" />';
					}
