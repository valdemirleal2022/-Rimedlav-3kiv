...
<div class="content-wrapper">
	...
	<?php 
		...
		if(isset($_POST['cadastrar'])){
			...
			$cad['aprovacao_comercial_observacao'] = mysql_real_escape_string($_POST['aprovacao_comercial_observacao']);
			$cad['aprovacao_operacional_observacao'] = mysql_real_escape_string($_POST['aprovacao_operacional_observacao']);
                  ...
                  <div class="input-group">
                       <div class="input-group-addon">
                         <i class="fa fa-calendar"></i>
              			 ...
              			 <input type="date" name="aprovacao" class="form-control pull-right" value="<?php echo $edit['aprovacao'];?>" disabled/>
                </div><!-- /.input group -->
           </div> 
                  ...
                  <div class="input-group">
                       <div class="input-group-addon">
                         <i class="fa fa-calendar"></i>
              			 ...
              			 <input type="date" name="inicio" class="form-control pull-right" value="<?php echo $edit['inicio'];?>" disabled/>
                </div><!-- /.input group -->
           </div> 
