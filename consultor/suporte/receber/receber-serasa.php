<?php 
	...
	$leitura = read('receber',"WHERE vencimento<='$data1' AND serasa='1' ORDER BY id_cliente ASC, vencimento DESC");
	...
	if(isset($_POST['pesquisar_nome'])){
		...
		$leitura = read('receber',"WHERE vencimento<='$data1' AND serasa='1' AND id_cliente='$clienteId' ORDER BY id_cliente ASC, vencimento DESC");
