            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="footer"><a href="#">Notificações</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown tasks-menu">
               ...
               <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php 
					 ...
					 if(!empty($_SESSION['autpos_venda']['fotoperfil'])){
						   echo '<img src="'.URL.'/uploads/pos_vendas/'.$_SESSION['autpos_venda']		['fotoperfil'].'" class="user-image"/>';
						  }else{
				...
				?>
                  <span class="hidden-xs">Pos-Venda</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
