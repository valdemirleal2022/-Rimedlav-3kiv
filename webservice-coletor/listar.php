...
$leitura = read('contrato_ordem',"WHERE id AND data='$dataRota' AND rota='$rotaId' ORDER BY data DESC, hora ASC"); 
   ...
   foreach($leitura as $mostra):
		...
		if($listar=='SIM'){
			...
			if($clienteLeitura){
				...
				$cad["referencia"] = tirarAcentos($cliente['referencia']);
				$cad["referencia"] = ucwords(strtolower($cad["referencia"])); 
				$cad["referencia"] = trim($cad["referencia"]); 
			}
